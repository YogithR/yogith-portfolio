...
function FeaturedProjectCard({
  ...
  return (
    ...
    >
      ...
      <div className="relative grid gap-8 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,1fr)] lg:items-start lg:gap-10">
        <ProjectImage project={project} className="aspect-[16/10] w-full shrink-0" />
